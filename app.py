...
tiempo_limite = 50  # Tiempo límite de 60 segundos
en_pausa = False
ganado = False
obstaculos = set()
...
def setup():
    ...
    py5.background(80, 50, 30)  # Fondo de color marrón oscuro
    py5.stroke_weight(6)
...
def draw():
    ...
    py5.background(80, 50, 30)  # Fondo con temática de jungla/madera
